# This script is to create a new windows appservice plan using azure cli. 
...
& $azcli appservice plan create --name $resourceGroup.name --resource-group $resourceGroup.name --location $resourceGroup.location --sku $sku | Out-Null
if(!$?){
